...
<div class="modal fade" id="addCategory" tabindex="-1" role="dialog" aria-labelledby="addCategory" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addCategory">เพิ่มหมวดหมู่</h5>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="CategoryNew" value="">
                    </div>
                </div>
            </div>
...
<script src="<?php echo $website;?>/vendor/jquery-easing/jquery.easing.min.js"></script>

<script src="<?php echo $website;?>/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
<!-- Custom scripts for all pages-->
<script src="<?php echo $website;?>/js/sb-admin-2.min.js"></script>

<!-- Page level plugins -->
<script src="<?php echo $website;?>/vendor/chart.js/Chart.min.js"></script>
